...
export default function SessionDeviceView() {
    return (
        <section className="col-span-7 xl:col-span-3 font-bold flex items-center justify-between min-h-[100px] md:min-h-[140px] font-roboto bg-white rounded-base p-4 md:px-7">
